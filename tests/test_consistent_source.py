...
def test_consistent_source_checker():
    ...
    directory_dfs(good_contest_path, [], [check_consistent_source.ConsistentSourceChecker], collect_error)
    ...
    directory_dfs(bad_contest_path, [], [check_consistent_source.ConsistentSourceChecker], collect_error)
